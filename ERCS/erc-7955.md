...
Instead of using a publicly known `DEPLOYER_PRIVATE_KEY`, you could use Nick's method to generate a random EIP-7702 authorization signature. This would prevent the front-running and forward compatibility issues described above.
